    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredientes', models.TextField(blank=True, help_text='Formato: - Ingrediente 1\n- Ingrediente 2, etc.', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('producto', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='opiniones', to='core.producto')),
            ],
        ),
    ]
